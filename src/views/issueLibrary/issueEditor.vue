    ...
    <div class="dev_show bgStyles">
      <el-form ref="dynamicValidateForm" :rules="rules" :model="dynamicValidateForm" label-width="100px" class="demo-dynamic">
          ...
          <el-col :span="18">
            <div>
              <el-form-item label="议题说明" prop="topicDesc">
                <el-input size="small" v-model="dynamicValidateForm.topicDesc" />
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="18">
          ...
          <el-col :span="18">
            <div>
              <el-form-item label="选项类型" prop="optionTypes">
                <!-- <el-radio-group v-model="dynamicValidateForm.optionTypes"> -->
        ...
        <el-row>
          <el-col :span="18">
            <div>
              <el-form-item v-for="(item, index) in dynamicValidateForm.options" :label="'议题选项' + (index+1)" :key="index"
          ...
          <el-col :span="18">
            <div>
              <el-form-item label="发起部门：">
                <el-tag v-for="(tag,key) in dynamicValidateForm.department" :key="key" closable :disable-transitions="false"
        ...
        <div v-if="dynamicValidateForm.biddingType === '0'">
          <el-form-item label="专家名称：">
            ...
            <el-row>
              <el-col :span="10">
                <div>
                  <el-tag size="mini" v-for="(tag,index) in dynamicValidateForm.specialistName" closable :key="index"
        ...
        <el-row style="margin-left:100px;margin-top:30px">
          <!-- <el-col :span="10">
            <el-upload ref="upload" class="upload" :action="uploadUrl()" :on-success="handleSuccess" :limit=1 multiple
  ...
  export default {
    ...
    data() {
      return {
        ...
        dynamicValidateForm: {
          ...
          options: [{
            option: '',
            optionDesc: '', //到底大写小写  反参是 optionDesc //因为接受的入参 议题选项描述字段有争议 提交时入参是optionDesc 进入编辑详情页面反参是 optionDesc
            key: Date.now()
          }],
        },
        //提交入参
    ...
    methods: {
      ...
      issuesDetail() {
        issuesdetail(this.$route.query.id).then(res => {
          if (res.code == 0) {
            ...
            this.dynamicValidateForm.biddingType = String(res.data.Issues.biddingType)
      ...
      queDingDepartment() {
        ...
        // this.dynamicValidateForm.department = this.selectOrg.orgsid
      },
      ...
      expertConfirm() {
        ...
        // this.pbChecked.forEach((item, index, arr) => {
        //   this.addFormData.pbTags.push(item)
        // })
        //this.addFormData.pbTags = this.pbChecked
      ...
      handleSuccess(response, file, fileList) {
        //上传成功要处理的事
        this.dynamicValidateForm.fileName = response.data.fileName
        this.dynamicValidateForm.url = response.data.url
      },
      //点击提交
      submit(formName) {
        //校验
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.addIssuesParameter.sponsorDept = this.dynamicValidateForm.department[0].deptId //发起部门
            this.addIssuesParameter.id = this.$route.query.id
